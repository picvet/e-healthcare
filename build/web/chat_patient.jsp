...
<%@page import="com.ehealthcare.business.MessagesFacadeLocal"%>
<!DOCTYPE html>
<!--
...
<body>
    ...
    <form method="POST" action="MessageSendServlet.do">
        <div class="container-div">
            ...
            <div class="footer">
                <form>
                    <input type="text" name="message" id="user-message" placeholder="Enter your message" required=""/>
